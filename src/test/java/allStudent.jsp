          ...
          <tr>
            <c:if test="${student!=null}">
              <td style="text-align: center">
                <a class="btn btn-primary" href = "${pageContext.request.contextPath}/student/signInStatus?id=${student.id}" >已到</a>
                &nbsp; | &nbsp;
                <a class="btn btn-primary" href = "${pageContext.request.contextPath}/student/signOutStatus?id=${student.id}">缺勤</a>
              </td>
            </c:if>
            ...
            <c:if test="${student!=null}">
              <td style="text-align: center">
                <a class="btn btn-primary" href = "${pageContext.request.contextPath}/student/toUpdateStudent?id=${student.id}" >修改</a>
                &nbsp; | &nbsp;
                <a class="btn btn-primary" href = "${pageContext.request.contextPath}/student/deleteStudent/${student.id}">删除</a>
              </td>
            </c:if>
